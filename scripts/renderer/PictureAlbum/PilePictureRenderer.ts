...
class PilePictureRenderer implements Renderer<PictureAlbum> {
    ...
    render(info : PictureAlbum, domElem : any, rendererTheme : string, endCallback : Function) {
        ...
        var wrapperHTML = $("<div>");
        wrapperHTML.addClass("PilePictureRenderer_wrapper");
        ...
        info.getPictures().forEach(function(picture : Picture) {
            ...
            if(picURL != null) {
                var pictureHTML = $("<div>");
                pictureHTML.addClass("PilePictureRenderer_picture");
