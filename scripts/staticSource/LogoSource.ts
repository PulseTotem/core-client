...
class LogoSource extends StaticSource<PictureAlbum> {
	...
	computeInfo() : PictureAlbum {
		...
		picture.setDurationToDisplay(parseInt(this.params.InfoDuration));

		var pictureURL : PictureURL = new PictureURL();
		pictureURL.setId(this.params.LogoName + " URL");
		pictureURL.setURL(this.params.URL);
		pictureURL.setDurationToDisplay(parseInt(this.params.InfoDuration));
		...
		pictureAlbum.setDurationToDisplay(parseInt(this.params.InfoDuration));
